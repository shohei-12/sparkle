...
ActiveRecord::Schema.define(version: 20_210_119_131_514) do
  ...
  create_table 'likes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id record_id], name: 'index_likes_on_user_id_and_record_id', unique: true
  end
  ...
  create_table 'records', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[user_id date], name: 'index_records_on_user_id_and_date', unique: true
  end
