...
const RecordRegistration: React.FC = () => {
  ...
  return (
    <div className="wrap">
      {currentUserId === uid ? (
        <>
          <ImageField text="見た目を記録する（最大5枚）" sheets={4} profile={false} setAppearances={setAppearances} />
          <TextInput
            fullWidth={true}
            label="メモ"
            multiline={true}
          ...
          />
          <ImageField text="朝食を記録する（最大3枚）" sheets={2} profile={false} setBreakfasts={setBreakfasts} />
          <TextInput
            fullWidth={true}
            label="メモ"
            multiline={true}
          ...
          />
          <ImageField text="昼食を記録する（最大3枚）" sheets={2} profile={false} setLunchs={setLunchs} />
          <TextInput
            fullWidth={true}
            label="メモ"
            multiline={true}
            ...
            onChange={inputLunch}
          />
          <ImageField text="夕食を記録する（最大3枚）" sheets={2} profile={false} setDinners={setDinners} />
          <TextInput
            fullWidth={true}
            label="メモ"
            multiline={true}
          ...
          />
          <ImageField text="間食を記録する（最大3枚）" sheets={2} profile={false} setSnacks={setSnacks} />
          <TextInput
            fullWidth={true}
            label="メモ"
            multiline={true}
