        ...
        axios
          ...
          .then(() => {
            if (replyComment && commentListIndex !== undefined) {
              ...
              const result = replyComments.filter((ele) => ele.comment_id !== id);
            ...
            <div className={classes.comment}>
              ...
              <div className={classes.right}>
                ...
                <div className={`${classes.commentTrigger} ${classes.alignItemsCenter}`}>
                  <span className="pointer-h" onClick={() => setCommentId(ele.comment_id)}>
                    返信
                  </span>
                  {ele.author_id === currentUserId && (
                    <Tooltip title="削除" placement="right">
                      <IconButton aria-label="コメントを削除する" onClick={() => deleteComment(ele.comment_id, false)}>
